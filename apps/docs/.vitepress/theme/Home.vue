<template>
  <main id="content" role="main">
    <section class="bd-masthead pt-3 pt-sm-5 pb-2">
      <BContainer tag="article">
        <BRow align-v="center" no-gutters class="mb-2 mb-md-3 mb-lg-4">
          <!-- eslint-disable-next-line vue/max-attributes-per-line -->
          <BCol tag="aside" cols="12" md="4" order-md="2" class="logo-aside mb-4 mb-md-0">
            <BvLogo></bvLogo>
          </BCol>
          <BCol tag="header" cols="12" md="8" order-md="1">
            <h1 class="mb-3 text-center text-md-left bd-text-purple-bright">
              BootstrapVue<span class="text-vue-green">Next</span>
            </h1>
            ...
            <div no-body class="my-3">
              ...
              <div class="ml-3 text-muted align-self-center">
                <a href="#" target="_blank">Bootstrap v4</a> is the world's most popular
                framework for building responsive, mobile-first sites.
              </div>
            </div>

            <div no-body class="mb-4">
              <div vertical-align="center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="mb-0 text-muted text-center mb-n4 mb-md-n5">
          Current Version<br>
          <b-link to="/docs/reference/changelog" class="small">v0.0.0</b-link>
        </p>
      </BContainer>
    </section>
      ...
      <BContainer tag="article">
        <div class="d-flex flex-column">
          <div class="order-2 order-md-1">
            ...
            <BRow class="mb-4">
              <BCol lg="10" offset-lg="1">
                <p class="text-lg-center">
                  With more than 85 components, over 45 available plugins, several directives, and 0.0.0+ icons,
                  <span class="bd-text-purple-bright">BootstrapVue</span> provides one of the most
                  comprehensive implementations of the
                  <span class="bd-text-purple-bright">Bootstrap v0.0.0</span> component and grid system
                  available for <span class="bd-text-purple-bright">Vue.js v0.0.0</span>, complete with
            ...
            <BRow class="justify-content-lg-center">
              <BCol md="4" lg="3">
                <BButton
                  to="/docs"
                  variant="bd-primary"
        ...
        <BCardGroup deck class="mb-n3">
          <b-card tag="article" body-text-variant="muted" class="rounded-0 border-0">
            ...
            <b-card-text class="text-center" bg-variant="light">
              Built with <a href="https://vuejs.org/">Vue.js v0.0.0</a> and
              <a href="https://getbootstrap.com">Bootstrap SCSS v0.0.0</a>
            </b-card-text>
          </b-card>
    ...
    <section class="bv-section bv-gray">
      <BContainer tag="article" class="text-center">
